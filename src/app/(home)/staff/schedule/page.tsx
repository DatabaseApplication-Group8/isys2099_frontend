...
export default function Schedule() {
  ...
  useEffect(() => {
    if (selectedDate) {
      ...
      const mockPersonalSchedule = [
        ...
        // More mock data for personal schedule
      ];
  ...
  const handleUpdateSchedule = () => {
    ...
    alert('Personal schedule updated!');
  };
  ...
  return (
    <div className="schedule p-8 bg-[#E6F0FF] min-h-screen"> 
        ...
        {/* Right Side: Treatments and Appointments */}
        <div className="w-[60%]">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {appointments.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="5" className="py-4 text-center text-gray-500">No appointments for this date.</td>
                    </tr>
                  )}
                </tbody>
              </table>
