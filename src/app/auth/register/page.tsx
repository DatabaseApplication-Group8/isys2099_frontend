                                ...
                                >
                                    {showPassword ? (
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 9.72727C1 9.72727 5.36364 1 13 1C20.6364 1 25 9.72727 25 9.72727C25 9.72727 20.6364 18.4545 13 18.4545C5.36364 18.4545 1 9.72727 1 9.72727Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.9998 13C14.8073 13 16.2725 11.5348 16.2725 9.72732C16.2725 7.91984 14.8073 6.45459 12.9998 6.45459C11.1923 6.45459 9.72705 7.91984 9.72705 9.72732C9.72705 11.5348 11.1923 13 12.9998 13Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    )}
                                </div>
                            </div>
