      ...
      <main className="flex flex-col flex-grow bg-white p-12 justify-center items-center">
        <div className="container p-12 max-w-4xl rounded-lg bg-[#BFD2F8] bg-opacity-[50%] shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="container-content grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="mInit" className="text-sm font-semibold text-[#1F2B6C]">
                Middle Name
              </label>
              <input
                required
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="address" className="text-sm font-semibold text-[#1F2B6C]">
                Address
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="allergies" className="text-sm font-semibold text-[#1F2B6C]">
                Allergies
              </label>
              <input
                type="text"
