...
const TreatmentStatusModal: React.FC<TreatmentStatusModalProps> = ({ isOpen, onClose, onConfirmCancellation }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="relative bg-white p-6 rounded-lg shadow-lg z-60">
                <h2 className="text-xl font-semibold mb-4">Cancel Treatment</h2>
...
export default TreatmentStatusModal;
